...
export class ImageUpload extends React.Component {
    constructor(props) {
        super(props);
        this.state = { file: '', imagePreviewUrl: dummy_dp };
    }
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        else if (!nextProps.currentImage) {
            return ({ imagePreviewUrl: dummy_dp })
        }
    }
    ...
    render() {
        ...
        // if (imagePreviewUrl) {
        $imagePreview = (<div style={{display: 'flex' ,justifyContent: 'center'}}><img alt="profileImg" src={imagePreviewUrl ? imagePreviewUrl : dummy_dp} className="imgPreview"
        // style={{ height: 200, width: 200 ,resize: 'both',borderRadius:100}}
        /></div>);
        // } else {
        ...
        return (
            <div className="previewComponent">
                ...
                <div className="changeButtonContainer">
                    <p onClick={() => this.props.onChangeImage("")} className="change_button">remove</p>
                    <p onClick={this.onClickUpload} className="change_button">Change</p>
                </div>
                </div>
