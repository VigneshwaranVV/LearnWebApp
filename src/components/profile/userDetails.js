...
import { deleteUser, registerUser } from "../../store_config/actions";
...
const profile_dp = "https://cdn.business2community.com/wp-content/uploads/2017/08/blank-profile-picture-973460_640.png";
...
const mapStateToProps = (state, props) => {
  ...
  return {
    ...
    afterRegister: state.authReducer.registerUserResponse && state.authReducer.registerUserResponse.message,
    afterDelete:state.authReducer.deleteUserResponse && state.authReducer.deleteUserResponse.message
  }
}
