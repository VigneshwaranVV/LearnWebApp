...
import "./styles.css"
import { registerUser, clearAuthStatusMessage } from "../../store_config/actions";
...
let ApplyForm = props => {
    ...
    const onClickOK = () => {
        if (props.statusMessage && props.statusMessage.type && props.statusMessage.type === 'success')
            props.history.replace(RouteConfig.login)
        props.clearAuthStatusMessage();
    }
        ...
        <div className="container">
                ...
                >
                    ...
                    <DialogActions>
                        <Button onClick={onClickOK} color="primary">
                            {props.statusMessage && props.statusMessage.type && props.statusMessage.type === 'success' ? "Login" : "Ok"}
                        </Button>
                    </DialogActions>
                </Dialog>
            }
            <div className="form_container" >
                <form onSubmit={onclickSubmit} style={{ width: "80%" }}>
                    <h2>Sign Up!</h2>
                    {/* <Field name="profile_img" label="UploadImage"  component={() => <p style={{ backgroundColor: "red" }} onClick={onClickUpload}><img id="output" width="200" src={profile_img}/></p>} type="file" /> */}
                    {/* <input type="file" style={{ display: "none" }} id="file-upload" onChange={onChangeFile} value={profile_img}/> */}
